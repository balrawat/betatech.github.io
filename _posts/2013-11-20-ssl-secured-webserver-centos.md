...
---
![](https://4.bp.blogspot.com/-zmAUfh-AZJs/Uom_Z1RP5RI/AAAAAAAAApU/8qsZwX1JwBk/s1600/https.png)
...
Just as you set [VirtualHosts] VirtualHostsfor http on port 80 so you do for https on port 443. A typical [VirtualHost] VirtualHostfor a site on port 80 looks like this
...
and then a [VirtualHost] VirtualHostrecord something like this:
