...
---
![](https://1.bp.blogspot.com/-cK8ZgtJZA00/UnyEyRENxlI/AAAAAAAAAnc/CKm6B9rdO7U/s1600/LVM+snapshots.png)
...
\# lvcreate -s -L 20M -n volume1\`snapshot /dev/volume\`group/volume1
...
\# lvconvert --merge /dev/volume\`group/volume1\`snapshot
