...
To run the examples in this tutorial, you need to install [Ubuntu Server Edition] Ubuntu Server Edition on a computer or a virtual machine, such as [Sun VirtualBox] Sun VirtualBox. You also need an Internet connection to download specific software packages used in the tutorial.
